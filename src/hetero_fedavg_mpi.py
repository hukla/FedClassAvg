...
for round_idx in range(1, args.max_rounds + 1):
    ...
    for active_idx, active in enumerate(virtual_nodes):
        ...
        model_state_dict['fc.fcout.weight'] = round_state_dict['fc.fcout.weight']
        model_state_dict['fc.fcout.bias'] = round_state_dict['fc.fcout.bias']
    ...
    if args.tsne and mpi_rank == 0:
        ...
        # for images, labels in test_dl:
            # preds, label_arr, client_label, performance = utils.generate_tsne_features(client_models, images, labels, device)
    ...
    for active_idx, active in enumerate(virtual_nodes):
        ...
        model_state_dict = model.state_dict()
        model_state_dict['fc.fcout.weight'] = global_state_dict['fc.fcout.weight']
        model_state_dict['fc.fcout.bias'] = global_state_dict['fc.fcout.bias']
